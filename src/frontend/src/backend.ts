...
export class Backend implements backendInterface {
    ...
    async addMotivation(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addMotivation(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addQuestion(arg0: string, arg1: Array<string>, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllMotivations(): Promise<Array<Motivation>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllMotivations();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRandomMotivation(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getRandomMotivation();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isAnswerCorrect(arg0: bigint, arg1: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isAnswerCorrect(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
