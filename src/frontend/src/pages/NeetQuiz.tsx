...
import { NEET_QUESTIONS, type NeetQuestion } from "@/data/neetQuizData";
...
const SUBJECT_COLORS: Record<NeetQuestion["subject"], string> = {
  Physics: "oklch(0.42 0.22 265)",
  Chemistry: "oklch(0.38 0.16 185)",
  Biology: "oklch(0.40 0.18 145)",
};

const SUBJECT_BG: Record<NeetQuestion["subject"], string> = {
  Physics: "oklch(0.92 0.05 265 / 0.8)",
  Chemistry: "oklch(0.92 0.06 185 / 0.8)",
  Biology: "oklch(0.92 0.07 145 / 0.8)",
};

const SubjectIcon = ({ subject }: { subject: NeetQuestion["subject"] }) => {
...
export default function NeetQuiz() {
  ...
  const questions = NEET_QUESTIONS;
      ...
      <div className="container mx-auto px-4 py-12 max-w-lg">
        ...
        >
          ...
          <div className="flex items-center justify-center mb-6">
            <div
              className="w-20 h-20 rounded-full flex items-center justify-center shadow-glow animate-float"
              style={{
                background:
          ...
          <div className="text-center mb-8">
            <div
              ...
              style={{
                background: "oklch(0.40 0.18 145 / 0.10)",
                color: "oklch(0.40 0.18 145)",
                border: "1px solid oklch(0.40 0.18 145 / 0.20)",
              }}
            >
              NEET Challenge
            </div>
            ...
            <p className="text-muted-foreground text-base leading-relaxed">
              Enter your name to receive a personalised NEET certificate upon
              completion! 🎓
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-12 h-14 text-base rounded-2xl border-2 bg-background font-semibold text-foreground placeholder:text-muted-foreground/60 transition-colors"
                style={{ borderColor: "oklch(0.88 0.04 145 / 0.8)" }}
                autoFocus
              />
            </div>

            <Button
              data-ocid="neet.quiz.submit_button"
              size="lg"
              disabled={!studentName.trim()}
              onClick={() => setQuizStarted(true)}
              className="w-full text-white font-bold text-base py-6 rounded-2xl hover:scale-[1.02] transition-all duration-200 border-0 h-auto disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
              style={{
                background:
                  "linear-gradient(135deg, oklch(0.40 0.18 145), oklch(0.52 0.20 160))",
          ...
          <div
            ...
            style={{ borderColor: "oklch(0.92 0.04 145 / 0.5)" }}
          >
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div className="flex items-center gap-3">
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, oklch(0.40 0.18 145), oklch(0.52 0.20 160))",
              boxShadow: "0 4px 12px -2px oklch(0.40 0.18 145 / 0.45)",
            }}
          >
        ...
        <div className="flex items-start gap-3 mb-6">
          <span
            ...
            style={{
              background:
                "linear-gradient(135deg, oklch(0.40 0.18 145), oklch(0.52 0.20 160))",
              boxShadow: "0 2px 8px -2px oklch(0.40 0.18 145 / 0.4)",
            }}
          >
            {currentIndex + 1}
          </span>
      ...
      {isAnswered && (
        <div className="space-y-3 mb-6 animate-scale-in">
          ...
          <div
            ...
            style={{
              background: "oklch(0.97 0.02 145 / 0.6)",
              borderColor: "oklch(0.40 0.18 145 / 0.25)",
            }}
          >
      ...
      {isAnswered && (
        <Button
          data-ocid="neet.quiz.primary_button"
          size="lg"
          onClick={handleNext}
          className="w-full text-white font-bold text-base py-6 rounded-2xl hover:scale-[1.02] transition-all duration-200 border-0 h-auto animate-fade-in"
          style={{
            background:
              "linear-gradient(135deg, oklch(0.40 0.18 145), oklch(0.52 0.20 160))",
            boxShadow: "0 4px 20px -4px oklch(0.40 0.18 145 / 0.45)",
          }}
        >
          {isLastQuestion ? (
            <>
