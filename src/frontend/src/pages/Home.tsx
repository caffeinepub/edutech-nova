...
import { ArrowRight, BookOpen, Brain, Sparkles, Star, Zap } from "lucide-react";
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-white/70 text-lg md:text-xl mb-10 leading-relaxed animate-fade-in">
              Challenge your knowledge with interactive quizzes and fuel your
              study sessions with powerful motivational messages.
            </p>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <button
              type="button"
              className="group text-left cursor-pointer bg-card rounded-3xl p-8 border border-border shadow-card card-hover"
              onClick={() => navigate({ to: "/quiz" })}
            >
              ...
              <p className="text-muted-foreground leading-relaxed mb-5">
                Test your knowledge with multiple-choice questions. Get instant
                feedback and track your score as you go.
              </p>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed mb-5">
                ...
                messages to keep you going strong.
              </p>
